  ...
  methods: {
    ...
    */
    axiosCall: function axiosCall(obj) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://localhost:8000/api/houses/advsearch', {
        params: {
          city: obj,
          radius: this.radius,
          beds: this.beds,
