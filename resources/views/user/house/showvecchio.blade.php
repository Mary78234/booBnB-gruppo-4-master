...
@section('content')
<div class="container bg-dark col-xs-12 offset-md-3 col-md-6">
    
    <h1 class="text-center">Dettagli: {{ $house->title }}</h1>
    ...
    <h3>Posizione:</h3>
    {{-------------------------MAPPA----------------------}}
    <div class="mb-3" style="width:100%; height: 75vh; margin: 0 auto;" id='map-div'></div>
    {{-------------------------MAPPA----------------------}}


    <div>
        <a class="btn btn-dark mb-3" href="{{ route('user.house.edit', $house) }}">Modifica</a>
    </div>
