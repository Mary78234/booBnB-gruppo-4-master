...
<div class="container edit-container">
    ...
    <div class="form-container col-xs-12 offset-md-2 col-md-8">
        ...
        @method('PATCH')
            ...
            <div class="mb-4">
                <label class="label-control" for="title">
                    TITOLO
                </label>  
                <input 
                type="text" 
            ...
            <div class="mb-4">
                <div>
                    <label class="label-control" for="image">
                        CAMBIA IMMAGINE
                    </label>
                </div>
                <div class="mb-2">
            ...
            <div class="details">
                <div class="mb-4">
                    <label class="label-control" for="rooms_number">
                        STANZE
                    </label>
                    <input 
                        type="number" 
                        ...
                        value="{{ old('rooms_number', $house->rooms_number) }}">
                    @error('rooms_number')
                ...
                <div class="mb-4">
                    <label class="label-control" for="bathrooms">
                        BAGNI
                    </label>
                    <input 
                        type="number" 
                ...
                <div class="mb-4">
                    <label class="label-control" for="square_metre">
                        METRI QUADRI
                    </label>
                    <input 
                        type="number" 
                        ...
                        id="square_metre"
                        name="square_metre" 
                        value="{{ old('square_metre', $house->square_metre) }}" 
                        class="form-control">
                </div>
            </div>
            ...
            <div class="address">
                <div class="mb-4">
                    <label class="label-control" for="country">
                        STATO
                    </label>
                    <input 
                        type="text" 
                ...
                <div class="mb-4">
                    <label class="label-control" for="region">
                        REGIONE
                    </label>
                    <input 
                        type="text" 
            ...
            <div class="address">
                ...
                <div class="mb-4">
                    <label class="label-control" for="house_number">
                        NUMERO CIVICO
                    </label>
                    <input 
                        type="number" 
                        onKeyPress="if(this.value.length==3) return false;" 
                        max="999" id="house_number" 
                        name="house_number" 
                ...
                <div class="mb-4">
                    <label class="label-control" for="postal_code">
                        CODICE POSTALE
                    </label>
                    <input 
                        type="number" 
                        onKeyPress="if(this.value.length==5) return false;" 
                        max="99999" id="postal_code" 
                        name="postal_code" 
                        class="form-control @error('postal_code') is-invalid @enderror" 
                        value="{{ old('postal_code', $house->postal_code) }}">
                    @error('postal_code')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="text-center">
                ...
                <a class="button" href="http://localhost:8000/house">Vedi risultato</a>
            </div>
        ...
        <div class="text-center">
            ...
            <form action="{{ route('user.house.destroy', $house) }}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
